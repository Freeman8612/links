...
* 填写参数取模生成取模文件   
<img src="./generate-params.png" style="width: 620px;">    
<img src="./点阵数据获取思路验证截图.gif" style="width: 300px">
<img src="./高速取模.gif" style="width: 313px">   
 

* 导出到linux开发版进行写入，读取测试，验证字库的完整性  
12点点阵   
![./flash中读出验证.gif](./GIF.gif)       
16点点阵   
